...
public class CtgDivisionUnionListAdapter extends ArrayAdapter<CtgDivisionUnionList> {

    public CtgDivisionUnionListAdapter(Context context, ArrayList<CtgDivisionUnionList> districtLists) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        CtgDivisionUnionList ctgDivisionUnionList = getItem(position);

        if (ctgDivisionUnionList != null) {

            textViewName.setText(ctgDivisionUnionList.getCtgUnionName());
        }
