...
public class SiletDivisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_silet_division);

        searchBTN = findViewById(R.id.searchBtnID);
        searchBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SiletDivisionActivity.this, UpWorkerListActivity.class);
