...
public class KhulnaDivisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg_division);

        searchBTN = findViewById(R.id.searchBtnID);
        searchBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KhulnaDivisionActivity.this, UpWorkerListActivity.class);
        ...
        districtSpinner.setAdapter(ctgDivisionMunicipalityListAdapter);
...
//                Toast.makeText(RajsahiDivisionActivity.this, clickedCountryName + " selected", Toast.LENGTH_SHORT).show();
        ...
        municipalitySpinner.setAdapter(ctgDivisionMunicipalityListAdapter);
