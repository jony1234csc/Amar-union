...
public class MaymonSingDivisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maymon_sing_division);

        searchBTN = findViewById(R.id.searchBtnID);
        searchBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MaymonSingDivisionActivity.this, UpWorkerListActivity.class);
